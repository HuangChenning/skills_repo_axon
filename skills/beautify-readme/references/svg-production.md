...
For structured diagrams that are easier to produce with a diagram engine, read [diagram-engines.md](diagram-engines.md). Use the engine as a production aid, export a static SVG or PNG, and embed the image file in GitHub-native context.
...
Also inspect a `360px` mobile preview. A dense technical diagram may preserve its overall structure there, but any detail required to understand or use the project must remain available in the adjacent Markdown and alt text.
...
- Hero title: `48+` SVG units, weight 700–900, tight letter-spacing
- Subtitle / summary: `28–36` units, weight 400–500
- Body text: `20–24` units, weight 400
- Meta / tags / captions: `16–18` units, weight 500–700, uppercase with letter-spacing
...
## Choose hand-authored SVG or a diagram engine deliberately
...
For hybrid composition, preserve the SVG layout and transparent raster subject as editable source layers. Do not rely on local or remote raster references inside the published SVG.
